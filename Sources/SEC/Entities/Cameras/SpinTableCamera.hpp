...
namespace Entities::Cameras {
	...
	class SpinTableCamera : public Camera {
	public:
		SpinTableCamera(glm::vec3 initialPos = glm::vec3(0.0), glm::vec3 rotatePoint = glm::vec3(0), glm::vec3 up = glm::vec3(0.0, 1.0, 0.0), bool alternate = false) {
			this->up = up;
			using namespace glm;
